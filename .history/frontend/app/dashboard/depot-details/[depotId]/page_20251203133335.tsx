...
export default function DepotDetailsPage() {
  ...
  const getTypeLabel = (type: string) => {
    // Lấy động từ containerTypes API thay vì hardcode
    const containerType = containerTypes.find(ct => ct.code === type)
    // Trả về code thay vì name dài (name có thể là "Cont 40' HC - cao Khô")
    return containerType ? containerType.code : type
  }
