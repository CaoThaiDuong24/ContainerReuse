...
export default function DepotDetailsPage() {
  ...
  const getTypeLabel = (type: string) => {
    // Trả về code từ containerTypes thay vì name (TenGoi)
    return type
  }
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="space-y-3">
                        ...
                        {/* Dates */}
                        {/* {(container.estimatedOutDate || container.returnEmptyDate) && (
                            ...
                            {container.returnEmptyDate && (
                              <div>
                                ...
                                <div className="text-sm font-medium text-red-600">
                                  {new Date(container.returnEmptyDate).toLocaleDateString('vi-VN')}
                                </div>
                              </div>
                            )}
                          </div>
