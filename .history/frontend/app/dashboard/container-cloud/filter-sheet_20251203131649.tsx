              ...
              <div className="space-y-2">
                ...
                <Select value={selectedSize} onValueChange={setSelectedSize}>
                  ...
                  <SelectContent>
                    ...
                    {/* Get unique sizes from containerTypes and map to container size format */}
                    {[...new Set(containerTypes.map(t => t.containerSize).filter((s): s is string => !!s))]
                      .sort()
                      .map((apiSize) => {
                        // Map API size format (20', 40', 45') to container size format (20ft, 40ft, 45ft)
              ...
              <div className="space-y-2">
                ...
                <Select value={selectedType} onValueChange={setSelectedType}>
                  ...
                  <SelectContent>
                    ...
                    {/* Get unique type codes from containerTypes */}
                    {[...new Set(containerTypes.map(t => t.code).filter((c): c is string => !!c))]
                      .sort()
                      .map((typeCode) => {
                        // Create label from type code
