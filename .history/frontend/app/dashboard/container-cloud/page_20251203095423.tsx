                      ...
                      return (
                        ...
                        >
                          <CardContent className="p-4">
                            {/* Depot Logo */}
                            {depot.logo && (
                              <div className="mb-3 h-20 rounded-lg overflow-hidden bg-white border border-gray-200">
                                <img 
                                  src={depot.logo} 
                                  alt={depot.name}
                                  ...
                                  onError={(e) => {
                                    ...
                                    (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=800&q=80'
                                  }}
                                />
                              </div>
                            )}
