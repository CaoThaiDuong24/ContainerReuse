          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="relative flex-1 min-w-[280px]">
              ...
              <Input
                ...
                className="pl-10 h-10 bg-white border-gray-300 focus:border-blue-500"
              />
            </div>
            ...
            {/* Result Count Badge */}
            <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 font-semibold px-4 py-2 shrink-0">
              {filteredContainers.length} kết quả
            </Badge>
          </div>
