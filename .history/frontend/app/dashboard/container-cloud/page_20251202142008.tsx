...
import { Search, MapPin, Package, Filter, RefreshCw, Box, Layers, TrendingUp, ChevronDown, ChevronUp, Ship, Container as ContainerIcon, BarChart3, X, SlidersHorizontal } from "lucide-react"
import {
  Select,
  SelectContent,
  SelectItem,
              ...
              <Sheet open={showFilters} onOpenChange={setShowFilters}>
                ...
                <SheetContent className="w-[400px] sm:w-[540px]">
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      Tùy chỉnh các tiêu chí lọc để tìm container phù hợp
                    </SheetDescription>
                  </SheetHeader>
                  ...
                  <div className="mt-6 space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 pb-2 border-b">
                        ...
                        <h3 className="font-semibold text-sm">Vị trí</h3>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={selectedProvince} onValueChange={(value) => {
                          ...
                          <SelectTrigger className={`w-full ${selectedProvince !== "all" ? "border-blue-500 bg-blue-50" : ""}`}>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={selectedDepot} onValueChange={setSelectedDepot}>
                          <SelectTrigger className={`w-full ${selectedDepot !== "all" ? "border-blue-500 bg-blue-50" : ""}`}>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 pb-2 border-b">
                        ...
                        <h3 className="font-semibold text-sm">Hãng tàu</h3>
                      </div>
                      
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-700">Chủ sở hữu</label>
                        <Select value={selectedShippingLine} onValueChange={setSelectedShippingLine}>
                          <SelectTrigger className={`w-full ${selectedShippingLine !== "all" ? "border-blue-500 bg-blue-50" : ""}`}>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 pb-2 border-b">
                        ...
                        <h3 className="font-semibold text-sm">Quy cách Container</h3>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select value={selectedSize} onValueChange={setSelectedSize}>
                          <SelectTrigger className={`w-full ${selectedSize !== "all" ? "border-blue-500 bg-blue-50" : ""}`}>
                      ...
                      {/* Type */}
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-700">Loại container</label>
                        <Select value={selectedType} onValueChange={setSelectedType}>
                          <SelectTrigger className={`w-full ${selectedType !== "all" ? "border-blue-500 bg-blue-50" : ""}`}>
                            <SelectValue placeholder="Chọn loại" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="all">Tất cả loại</SelectItem>
                            <SelectItem value="dry">Khô (Dry)</SelectItem>
                            <SelectItem value="reefer">Lạnh (Reefer)</SelectItem>
                            <SelectItem value="opentop">Nóc mở (Open Top)</SelectItem>
                            <SelectItem value="flatrack">Phẳng (Flat Rack)</SelectItem>
                            <SelectItem value="tank">Bồn (Tank)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
