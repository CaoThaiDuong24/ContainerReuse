                      ...
                      return (
                        ...
                        >
                          <CardContent className="p-4">
                            {/* Depot Logo - Only show if not default Unsplash image */}
                            {depot.logo && !depot.logo.includes('unsplash') ? (
                              <div className="mb-3 h-16 rounded-lg overflow-hidden bg-white border border-gray-200 shadow-sm">
                                <img 
                                  src={depot.logo} 
                                  alt={depot.name}
                              ...
                              <div className="mb-3 h-16 rounded-lg overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 flex items-center justify-center">
