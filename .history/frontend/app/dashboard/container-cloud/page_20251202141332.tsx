    ...
    <div className="flex flex-col h-[calc(100vh-5rem)] gap-3 p-4 overflow-hidden">
      ...
      <Card className="shrink-0 shadow-sm border-gray-200">
        <CardContent className="p-4">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <Button 
                ...
                className={showFilters 
                  ...
                  : "hover:bg-blue-50 hover:text-blue-600 border-gray-300"
                }
              >
                <Filter className="h-4 w-4 mr-1.5" />
                Bộ lọc
                {hasActiveFilters && (
                  <Badge variant="secondary" className="ml-1.5 px-1.5 h-5 min-w-5 bg-white text-blue-600">
                    {[selectedProvince, selectedDepot, selectedShippingLine, selectedSize, selectedType, selectedStatus]
          ...
          {/* Collapsible Filters - Single Row Compact Design */}
          {showFilters && (
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Select value={selectedProvince} onValueChange={(value) => {
                    ...
                    <SelectTrigger className={`h-8 w-[140px] text-xs ${selectedProvince !== "all" ? "border-blue-500 bg-blue-50" : "border-gray-300 bg-white"}`}>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Select value={selectedDepot} onValueChange={setSelectedDepot}>
                    <SelectTrigger className={`h-8 w-[150px] text-xs ${selectedDepot !== "all" ? "border-blue-500 bg-blue-50" : "border-gray-300 bg-white"}`}>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Select value={selectedShippingLine} onValueChange={setSelectedShippingLine}>
                    <SelectTrigger className={`h-8 w-[130px] text-xs ${selectedShippingLine !== "all" ? "border-blue-500 bg-blue-50" : "border-gray-300 bg-white"}`}>
                ...
                <Select value={selectedSize} onValueChange={setSelectedSize}>
                  <SelectTrigger className={`h-8 w-[100px] text-xs ${selectedSize !== "all" ? "border-blue-500 bg-blue-50" : "border-gray-300 bg-white"}`}>
                ...
                <Select value={selectedType} onValueChange={setSelectedType}>
                  <SelectTrigger className={`h-8 w-[110px] text-xs ${selectedType !== "all" ? "border-blue-500 bg-blue-50" : "border-gray-300 bg-white"}`}>
                ...
                <Select value={selectedStatus} onValueChange={setSelectedStatus}>
                  <SelectTrigger className={`h-8 w-[120px] text-xs ${selectedStatus !== "all" ? "border-blue-500 bg-blue-50" : "border-gray-300 bg-white"}`}>
              ...
              {selectedStatus === "all" && (
                <div className="flex items-center gap-2 mt-2.5 pt-2.5 border-t border-gray-100">
                  ...
                  <Button
                    ...
                    className="h-7 text-xs px-2.5 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-300"
                  >
