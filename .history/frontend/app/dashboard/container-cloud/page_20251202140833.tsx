  ...
  return (
    <div className="flex flex-col h-[calc(100vh-5rem)] gap-3 p-4 overflow-hidden">
      ...
      <div className="flex flex-1 gap-3 overflow-hidden">
        ...
        {/* Middle: Dynamic Panel - Shows Depots or Shipping Lines based on filter */}
            ...
            <CardHeader className="pb-2 pt-3 shrink-0">
              {selectedDepot === "all" ? (
                ...
                <>
                  ...
                  <CardDescription className="text-sm text-gray-600">
                    {Object.keys(shippingLineGroups).length} hãng
                  </CardDescription>
                </>
              )}
            </CardHeader>
                  ...
                  {selectedDepot === "all" ? (
                    ...
                    filteredDepots.map((depot) => {
                      ...
                      return (
                        <Card
                          key={depot.id}
                          className="hover:shadow-md transition-all cursor-pointer border hover:border-blue-400 bg-white"
                    ...
                    /* Show Shipping Line List */
                    Object.entries(shippingLineGroups)
                      .sort(([, a], [, b]) => b.count - a.count)
                      .map(([shippingLine, stats]) => (
                        <Card
                          key={shippingLine}
                          className={`hover:shadow-md transition-all cursor-pointer border ${
                            selectedShippingLine === shippingLine 
                              ? 'border-blue-500 bg-blue-50' 
                              : 'hover:border-blue-400 bg-white'
                          }`}
                          onClick={() => setSelectedShippingLine(shippingLine)}
                        >
                          <CardContent className="p-3">
                            <div className="space-y-2">
                              ...
                              <div className="flex items-start justify-between">
                                <div className="flex items-center gap-1.5 flex-1 min-w-0">
                                  ...
                                  <div className="text-xs font-bold text-gray-900 truncate">{shippingLine}</div>
                                </div>
                                <Badge variant="secondary" className="bg-blue-100 text-blue-700 text-xs shrink-0 ml-1">
                                  {stats.count}
                                </Badge>
                              </div>
