...
interface MapComponentProps {
  depots: Depot[]
  getDepotCoordinates: (depot: Depot) => { lat: number; lng: number }
}

// Component to fit bounds when depots change
function FitBounds({ depots, getDepotCoordinates }: MapComponentProps) {
  const map = useMap()
  ...
  }, [depots, getDepotCoordinates, map])

  return null
}

export default function MapComponent({ depots, getDepotCoordinates }: MapComponentProps) {
  ...
  return (
    <div className="w-full h-full rounded-lg overflow-hidden relative">
      ...
      >
        ...
        <FitBounds depots={depots} getDepotCoordinates={getDepotCoordinates} />
