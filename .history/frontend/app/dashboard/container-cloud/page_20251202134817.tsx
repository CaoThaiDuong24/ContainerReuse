                ...
                {loading ? (
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {filteredContainers.map((container) => (
                      <Card
                        key={container.id}
                        className="hover:shadow-lg transition-all duration-200 cursor-pointer border hover:border-blue-400 bg-gradient-to-br from-white to-gray-50/50"
                      >
                        <CardContent className="p-4">
                          ...
                          <div className="flex items-center gap-2 pb-3 mb-3 border-b border-gray-200">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="text-xs text-gray-500 font-medium">Depot</div>
                              <div className="text-sm font-semibold text-gray-900 truncate">{container.depotName}</div>
                            </div>
                          </div>
                          ...
                          <div className="space-y-2.5">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="text-sm font-semibold text-gray-900 truncate">{container.owner}</div>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex-1">
                                <div className="text-[10px] text-gray-500 uppercase tracking-wide">Kích thước & Loại</div>
                                <div className="text-sm font-semibold text-gray-900">
                                  <span className="text-purple-600">{container.size}</span> - {getTypeLabel(container.type)}
                                </div>
                              </div>
                            </div>
                            ...
                            {container.estimatedOutDate && (
                              <div className="flex items-center gap-2 pt-2 mt-2 border-t border-dashed border-gray-200">
                                ...
                                <div className="flex-1">
                                  <div className="text-[10px] text-gray-500 uppercase tracking-wide">Hạn Trả Rỗng</div>
                                  <div className="text-sm font-semibold text-orange-600">{container.estimatedOutDate}</div>
                                </div>
                              </div>
                            )}
                          </div>
