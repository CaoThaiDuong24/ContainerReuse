...
export default function ContainerCloudPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)] gap-4 p-6 bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
      {/* Filter Section - Top */}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-sm text-gray-600">
                Tìm kiếm và lọc container theo depot, loại và kích thước
              </CardDescription>
            </div>
            <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 font-semibold text-base px-4 py-2">
        ...
        <CardContent className="space-y-3 pt-4">
          ...
          <div className="flex gap-2">
            ...
            <Button 
              ...
              onClick={loadData}
              disabled={loading}
              className="hover:bg-blue-50 hover:text-blue-600 hover:border-blue-300 shrink-0"
            >
          ...
          <div className="flex items-center gap-3">
            <Select value={selectedDepot} onValueChange={setSelectedDepot}>
              <SelectTrigger className="h-9 w-auto min-w-[180px] bg-white border-gray-300">
            ...
            <Select value={selectedType} onValueChange={setSelectedType}>
              <SelectTrigger className="h-9 w-auto min-w-[150px] bg-white border-gray-300">
      ...
      <div className="flex flex-1 gap-6 overflow-hidden">
        ...
        <div className="w-1/2 flex flex-col overflow-hidden">
          <Card className="flex-1 flex flex-col overflow-hidden shadow-lg border-gray-200">
            <CardHeader className="pb-4 bg-gradient-to-r from-blue-50 to-indigo-50 shrink-0">
              <CardTitle className="flex items-center gap-2 text-gray-800">
                ...
                {loading ? (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {filteredContainers.map((container) => (
                      <Card
                        key={container.id}
                        className="hover:shadow-xl transition-all duration-300 cursor-pointer border-gray-200 hover:border-blue-400 hover:-translate-y-1 bg-white"
                      >
                        <CardContent className="p-4">
                          <div className="space-y-3">
                            <div className="flex items-start justify-between gap-2">
                              ...
                              <Badge className={`${getStatusColor(container.status)} font-medium shrink-0`}>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex items-center gap-2 text-gray-600">
                                ...
                                <span className="truncate font-medium">{container.depotName}</span>
                              </div>
                              
                              <div className="flex gap-2 flex-wrap">
                                <span className="bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-semibold border border-blue-200">
                                  {getTypeLabel(container.type)}
                                </span>
                                <span className="bg-gradient-to-r from-purple-50 to-purple-100 text-purple-700 px-3 py-1 rounded-full text-xs font-semibold border border-purple-200">
                                  {container.size}
                                </span>
                              </div>
                              ...
                              <div className="pt-2 border-t border-gray-100">
                                ...
                                <span className="text-gray-900 font-medium text-xs">{container.owner}</span>
                              </div>
                            </div>
                          </div>
                        </CardContent>
        ...
        <Card className="h-full flex flex-col shadow-lg border-gray-200">
          <CardHeader className="pb-4 bg-gradient-to-r from-green-50 to-emerald-50 shrink-0">
            <CardTitle className="flex items-center gap-2 text-gray-800">
