                          ...
                          <CardContent className="p-4">
                            ...
                            <div className="mb-3 pb-3 border-b border-gray-200">
                              <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-xs font-bold text-green-700 uppercase">Hãng tàu</span>
                                </div>
                              ...
                              {Object.keys(shippingLinesGrouped).length > 0 ? (
                                <div className="flex flex-wrap gap-2">
                                  {Object.entries(shippingLinesGrouped).map(([line, count], index) => (
                                    <Badge 
                                      key={`shipping-${depot.id}-${index}-${line}`}
                                      variant="outline" 
                                      className="bg-green-50 border-green-300 text-green-800 text-xs font-semibold"
                                    >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="text-xs font-semibold text-gray-700 truncate" title={depot.name}>
                                  {depot.name}
                                </div>
