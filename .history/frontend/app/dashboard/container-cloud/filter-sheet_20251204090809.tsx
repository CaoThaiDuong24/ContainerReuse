...
export function FilterSheet({
  ...
  console.log('🔍 FilterSheet - containerTypes:', containerTypes.length, containerTypes)
  console.log('🔍 FilterSheet - availableTypes:', availableTypes)
  console.log('🔍 FilterSheet - Sample containerType:', containerTypes[0])
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    {provinces.map((province, index) => (
                      <SelectItem key={`province-${index}-${province}`} value={province}>
                        {province}
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select value={selectedShippingLine} onValueChange={setSelectedShippingLine}>
                  ...
                  <SelectContent>
                    ...
                    {availableShippingLines.map((line, index) => (
                      <SelectItem key={`shipping-line-${index}-${line}`} value={line}>
                        {line}
                      </SelectItem>
                    ))}
                  </SelectContent>
