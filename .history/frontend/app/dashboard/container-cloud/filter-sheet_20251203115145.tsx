                ...
                <Select value={selectedType} onValueChange={setSelectedType}>
                  ...
                  <SelectContent>
                    ...
                    {containerTypes.length > 0 ? (
                      ...
                      <>
                        <SelectItem value="GP">🌾 Khô (GP)</SelectItem>
                        <SelectItem value="HC">📦 Cao (HC)</SelectItem>
                        <SelectItem value="RF">❄️ Lạnh (RF)</SelectItem>
                        <SelectItem value="UT">📂 Nóc mở (UT)</SelectItem>
                        <SelectItem value="PC">📐 Phẳng (PC)</SelectItem>
                        <SelectItem value="PF">📏 Phẳng cố định (PF)</SelectItem>
                        <SelectItem value="TN">🛢️ Bồn (TN)</SelectItem>
                      </>
                    )}
                  </SelectContent>
                </Select>
