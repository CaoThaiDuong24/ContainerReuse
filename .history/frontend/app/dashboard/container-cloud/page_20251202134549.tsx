                          ...
                          <div className="space-y-2.5">
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex items-start gap-2">
                                <MapPin className="h-4 w-4 flex-shrink-0 text-blue-500 mt-0.5" />
                                <div className="flex-1">
                                  <div className="text-gray-500 text-xs">Depot:</div>
                                  <div className="text-gray-900 font-medium">{container.depotName}</div>
                                </div>
                              </div>
                              
                              <div className="flex items-start gap-2">
                                <Package className="h-4 w-4 flex-shrink-0 text-green-500 mt-0.5" />
                                <div className="flex-1">
                                  <div className="text-gray-500 text-xs">Hãng Tàu:</div>
                                  <div className="text-gray-900 font-medium">{container.owner}</div>
                                </div>
                              </div>
                              
                              <div className="flex items-start gap-2">
                                <Box className="h-4 w-4 flex-shrink-0 text-purple-500 mt-0.5" />
                                <div className="flex-1">
                                  <div className="text-gray-500 text-xs">Kích thước & Loại:</div>
                                  <div className="text-gray-900 font-medium">
                                    {container.size} - {getTypeLabel(container.type)}
                                  </div>
                                </div>
                              </div>
                              ...
                              {container.estimatedOutDate && (
                                <div className="flex items-start gap-2">
                                  <TrendingUp className="h-4 w-4 flex-shrink-0 text-orange-500 mt-0.5" />
                                  <div className="flex-1">
                                    <div className="text-gray-500 text-xs">Hạn Trả Rỗng:</div>
                                    <div className="text-gray-900 font-medium">{container.estimatedOutDate}</div>
                                  </div>
                                </div>
                              )}
                            </div>
