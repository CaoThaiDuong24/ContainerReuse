                ...
                {loading ? (
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    {filteredContainers.map((container) => (
                      <Card
                        key={container.id}
                        className="hover:shadow-md transition-all duration-200 cursor-pointer border hover:border-blue-400 bg-gradient-to-br from-white to-gray-50/30"
                      >
                        <CardContent className="p-3">
                          {/* Header: Depot Name */}
                          <div className="flex items-center gap-2 pb-2 mb-2 border-b border-gray-200">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="text-[10px] text-gray-500 font-medium">Depot</div>
                              <div className="text-sm font-bold text-gray-900 truncate">{container.depotName}</div>
                            </div>
                          </div>
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <div className="flex-1 min-w-0">
                                <span className="text-[10px] text-gray-500">Hãng: </span>
                                <span className="text-xs font-semibold text-gray-900 truncate">{container.owner}</span>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <div className="flex-1">
                                ...
                                <span className="text-xs font-semibold text-purple-600">{container.size}</span>
                                <span className="text-xs text-gray-700"> - {getTypeLabel(container.type)}</span>
                              </div>
                            </div>

                            {/* Return Date */}
                            {container.estimatedOutDate && (
                              <div className="flex items-center gap-1.5 pt-1.5 mt-1.5 border-t border-dashed border-gray-200">
                                <div className="p-0.5 bg-orange-100 rounded">
                                  <TrendingUp className="h-3 w-3 text-orange-600" />
                                </div>
                                <div className="flex-1">
                                  <span className="text-[10px] text-gray-500">Hạn: </span>
                                  <span className="text-xs font-semibold text-orange-600">{container.estimatedOutDate}</span>
                                </div>
                              </div>
                            )}
                          </div>
