...
export default function ContainerCloudPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-8rem)] gap-6 p-6 bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
            ...
            <CardContent className="space-y-3 pt-6">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Select value={selectedDepot} onValueChange={setSelectedDepot}>
                  <SelectTrigger className="h-8 w-auto min-w-[140px] bg-white border-gray-300 text-xs">
                ...
                <Select value={selectedType} onValueChange={setSelectedType}>
                  <SelectTrigger className="h-8 w-auto min-w-[110px] bg-white border-gray-300 text-xs">
                ...
                <Select value={selectedSize} onValueChange={setSelectedSize}>
                  <SelectTrigger className="h-8 w-auto min-w-[130px] bg-white border-gray-300 text-xs">
