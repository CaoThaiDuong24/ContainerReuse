  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="container mx-auto p-6 space-y-6">
        ...
        {depot && (
          <Card className="dark:bg-slate-900/80 backdrop-blur-xl shadow-xl border-slate-200/50 dark:border-slate-800/50">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex-1 relative group">
                ...
                <Input
                  ...
                  className="pl-12 h-12 dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500 rounded-xl shadow-sm"
                  value={searchQuery}
              ...
              <Select value={filterStatus} onValueChange={setFilterStatus}>
                <SelectTrigger className="w-full md:w-[200px] h-12 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl shadow-sm">
              ...
              <Select value={filterType} onValueChange={setFilterType}>
                <SelectTrigger className="w-full md:w-[180px] h-12 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-xl shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {filteredContainers.length === 0 ? (
            <Card className="col-span-2 dark:bg-slate-900/80 backdrop-blur-xl shadow-xl border-slate-200/50 dark:border-slate-800/50">
            ...
            filteredContainers.map((container) => (
              <Card key={container.id} className="group dark:bg-slate-900/80 backdrop-blur-xl hover:shadow-2xl transition-all duration-300 border-slate-200/50 dark:border-slate-800/50 hover:border-blue-300 dark:hover:border-blue-700">
