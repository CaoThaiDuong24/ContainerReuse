                    ...
                    <CardContent className="p-0">
                      ...
                      <div className="p-4 border-b border-slate-100 dark:border-slate-800">
                        <div className="flex items-center gap-2.5 mb-3">
                          <div className="h-9 w-9 rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/50 flex items-center justify-center">
                          ...
                          <div className="h-10 w-16 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center p-1.5 shrink-0 shadow-sm">
                            <img 
                              ...
                              onError={(e) => {
                                ...
                                if (parent) {
                                  parent.innerHTML = `<span class="text-[10px] font-bold text-slate-500 dark:text-slate-400 text-center leading-tight">${container.owner.substring(0, 3).toUpperCase()}</span>`;
                                }
                              }}
                            />
                          </div>
