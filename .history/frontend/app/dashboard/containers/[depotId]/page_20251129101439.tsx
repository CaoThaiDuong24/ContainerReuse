    ...
    <TooltipProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-50 to-blue-50/30 dark:from-slate-950 dark:via-slate-950 dark:to-blue-950/10">
        <div className="w-full p-4 md:p-6 lg:p-8 space-y-6">
          ...
          {/* Filters & Search */}
          <div className="sticky top-0 z-40 -mx-4 md:-mx-6 lg:-mx-8 px-4 md:px-6 lg:px-8 py-4 bg-gradient-to-br from-slate-50 via-slate-50 to-blue-50/30 dark:from-slate-950 dark:via-slate-950 dark:to-blue-950/10 animate-in fade-in slide-in-from-top-4 duration-500">
            <Card className="border-none shadow-lg shadow-slate-200/50 dark:shadow-none bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl supports-[backdrop-filter]:bg-white/80 hover:shadow-xl transition-shadow">
              <CardContent className="p-4">
