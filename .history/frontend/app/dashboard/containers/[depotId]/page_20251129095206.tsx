          ...
          <CardContent className="p-4">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    className="pl-9 h-9 bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 focus-visible:ring-blue-500 focus-visible:border-blue-500 transition-all"
                    value={searchQuery}
                ...
                <div className="flex gap-2 flex-wrap sm:flex-nowrap">
                  ...
                  <Select value={filterStatus} onValueChange={setFilterStatus}>
                    <SelectTrigger className={`h-9 w-full sm:w-[160px] bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 transition-all ${filterStatus !== 'all' ? 'border-blue-500 ring-1 ring-blue-500 bg-blue-50/50 dark:bg-blue-950/20' : ''}`}>
                  ...
                  <Select value={filterType} onValueChange={setFilterType}>
                    <SelectTrigger className={`h-9 w-full sm:w-[140px] bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 transition-all ${filterType !== 'all' ? 'border-blue-500 ring-1 ring-blue-500 bg-blue-50/50 dark:bg-blue-950/20' : ''}`}>
                  ...
                  <Select value={filterSize} onValueChange={setFilterSize}>
                    <SelectTrigger className={`h-9 w-full sm:w-[120px] bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-700 transition-all ${filterSize !== 'all' ? 'border-blue-500 ring-1 ring-blue-500 bg-blue-50/50 dark:bg-blue-950/20' : ''}`}>
                  ...
                  {(searchQuery || filterStatus !== 'all' || filterType !== 'all' || filterSize !== 'all') && (
                    <Button 
                      variant="outline" 
                      size="sm"
                      className="h-9 px-3 border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800"
                      onClick={() => {
                        setSearchQuery('')
                        setFilterStatus('all')
                        setFilterType('all')
              ...
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                <span>
                  Hiển thị <span className="font-bold text-blue-600 dark:text-blue-400">{filteredContainers.length}</span> / {containers.length} containers
                </span>
                {filteredContainers.length < containers.length && (
                  <Badge variant="secondary" className="text-[10px] h-5 px-2 bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-300 border-0">
                    Đã lọc
                  </Badge>
                )}
              </div>
