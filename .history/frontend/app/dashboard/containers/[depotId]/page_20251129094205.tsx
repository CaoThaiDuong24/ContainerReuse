    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
      <div className="container mx-auto p-4 md:p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          <Card className="bg-white dark:bg-slate-900 border dark:border-slate-800 hover:shadow-md transition-shadow">
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-blue-600 dark:text-blue-400">{stats.inUse}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-orange-600 dark:text-orange-400">{stats.maintenance}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-purple-600 dark:text-purple-400">{stats.reserved}</p>
                </div>
              </div>
            </CardContent>
          </Card>
