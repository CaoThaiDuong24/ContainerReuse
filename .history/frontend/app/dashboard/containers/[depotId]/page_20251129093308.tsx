      ...
      <div className="container mx-auto p-4 md:p-6 space-y-4">
          ...
          <CardContent className="p-4">
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <Select value={filterStatus} onValueChange={setFilterStatus}>
                <SelectTrigger className="w-full md:w-[160px] h-9 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 text-sm">
                  <div className="flex items-center gap-1.5">
              ...
              <Select value={filterType} onValueChange={setFilterType}>
                <SelectTrigger className="w-full md:w-[140px] h-9 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 text-sm">
        ...
        <div className="flex items-center justify-between px-1">
          <p className="text-xs text-muted-foreground">
            Hiển thị <span className="font-bold text-blue-600">{filteredContainers.length}</span> / <span className="font-bold">{containers.length}</span> containers
          </p>
        </div>

        {/* Container List - Compact Grid Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3">
          {filteredContainers.length === 0 ? (
            <Card className="col-span-full bg-white dark:bg-slate-900 shadow-sm border-slate-200 dark:border-slate-800">
              <CardContent className="p-8">
                <div className="text-center">
                  <div className="inline-flex p-4 bg-slate-100 dark:bg-slate-800 rounded-full mb-3">
                    <Package className="h-8 w-8 text-slate-400" />
                  </div>
                  <h3 className="text-base font-bold mb-1 text-slate-900 dark:text-slate-100">Không tìm thấy container</h3>
                  <p className="text-xs text-muted-foreground">
            ...
            filteredContainers.map((container) => (
              <Card key={container.id} className="group bg-white dark:bg-slate-900 hover:shadow-md transition-shadow border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700">
                <CardContent className="p-4">
                  {/* Header */}
                  <div className="flex items-start gap-2.5 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-base font-bold text-slate-900 dark:text-slate-100 truncate mb-1.5">
                      ...
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        <Badge variant="outline" className="font-semibold text-[10px] px-1.5 py-0">
                          {container.size}
                        </Badge>
                  ...
                  <div className="space-y-2 mb-3">
                    ...
                    {container.estimatedOutDate && (
                      <div className="flex items-center gap-2 text-xs">
                        ...
                        <span className="text-muted-foreground min-w-[60px]">Dự kiến xuất:</span>
                  ...
                  <div className="flex gap-2">
                    {container.status === 'available' && (
                      <Button size="sm" className="flex-1 bg-blue-600 hover:bg-blue-700 gap-1.5 h-8 text-xs">
