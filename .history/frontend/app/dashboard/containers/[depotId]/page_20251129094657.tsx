        ...
        <Card className="bg-white dark:bg-slate-900 border dark:border-slate-800 shadow-sm">
          <CardContent className="p-4">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col md:flex-row gap-3">
                ...
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    className="pl-9 h-9 bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 focus:border-blue-500 dark:focus:border-blue-500 transition-colors"
                    value={searchQuery}
                ...
                <div className="flex gap-2 flex-wrap md:flex-nowrap">
                  ...
                  <div className="relative flex-1 md:w-40">
                    ...
                    <Select value={filterStatus} onValueChange={setFilterStatus}>
                      <SelectTrigger className={`h-9 pl-9 bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 transition-all ${filterStatus !== 'all' ? 'border-blue-500 bg-blue-50 dark:bg-blue-950/30' : ''}`}>
                  ...
                  <div className="relative flex-1 md:w-36">
                    ...
                    <Select value={filterType} onValueChange={setFilterType}>
                      <SelectTrigger className={`h-9 pl-9 bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 transition-all ${filterType !== 'all' ? 'border-blue-500 bg-blue-50 dark:bg-blue-950/30' : ''}`}>
                  ...
                  <div className="relative flex-1 md:w-32">
                    ...
                    <Select value={filterSize} onValueChange={setFilterSize}>
                      <SelectTrigger className={`h-9 pl-9 bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 transition-all ${filterSize !== 'all' ? 'border-blue-500 bg-blue-50 dark:bg-blue-950/30' : ''}`}>
                  ...
                  {(searchQuery || filterStatus !== 'all' || filterType !== 'all' || filterSize !== 'all') && (
                    <Button 
                      variant="ghost" 
                      size="sm"
                      className="h-9 px-3 text-xs hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-950/30 dark:hover:text-red-400"
                      onClick={() => {
                        setSearchQuery('')
                        setFilterStatus('all')
                        setFilterType('all')
              ...
              {/* Bottom Row: Results Count & Active Filters */}
