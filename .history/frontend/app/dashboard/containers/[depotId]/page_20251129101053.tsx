                ...
                {filteredContainers.length > 0 && (
                  <div className="mt-3 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-sm">
                    <span className="text-muted-foreground">
                      Hiển thị <span className="font-semibold text-foreground">{filteredContainers.length}</span> trong tổng số <span className="font-semibold text-foreground">{containers.length}</span> container
                    </span>
                  </div>
                )}
              </CardContent>
