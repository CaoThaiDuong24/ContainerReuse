          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {searchQuery ? 'Không tìm thấy container' : 'Chưa có container đã đăng ký từ API'}
              </h3>
              <p className="text-gray-600 text-center max-w-md mb-4">
                {searchQuery 
                  ? 'Thử điều chỉnh từ khóa tìm kiếm của bạn'
                  : 'Hiện tại không có container nào đã được đăng ký gate-out cho công ty này trong hệ thống external API. Dữ liệu sẽ được cập nhật tự động khi có container mới được đăng ký.'
                }
              </p>
