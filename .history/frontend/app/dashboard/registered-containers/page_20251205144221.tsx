...
export default function RegisteredContainersPage() {
  ...
  const fetchRegisteredContainers = async () => {
    try {
      ...
      console.log('Fetching registered containers from:', `${API_BASE_URL}/api/containers/registered-api`)
      console.log('User ID:', userId)
      
      const response = await fetch(`${API_BASE_URL}/api/containers/registered-api?userId=${userId}`, {
        method: 'GET',
        headers: {
