...
export default function UsersPage() {
  const users = [
    ...
    { id: "4", name: "Sarah Williams", email: "sarah@example.com", role: "User", status: "inactive", joinDate: "2024-04-05" },
  ]
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Quản lý người dùng và quyền truy cập</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500">87.5% of total</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500">10.4% growth</p>
          </CardContent>
        </Card>
      </div>
                  ...
                  <tr key={user.id} className="border-b hover:bg-gray-50">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-400 to-blue-400 flex items-center justify-center text-white font-medium">
                          {user.name.charAt(0)}
                        </div>
