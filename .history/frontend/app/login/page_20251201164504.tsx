        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-10">
            <h1 className="text-5xl font-bold mb-2">
              <span className="text-[#00D9A3]">Chào mừng đến</span>
            </h1>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#1a4d7a] via-[#0d2942] to-[#0a1f35] relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-right pr-20">
          <div className="relative inline-block">
            ...
            <h1 className="absolute text-7xl font-bold tracking-wider text-[#00D9A3]/30 blur-sm transform translate-x-2 translate-y-2">
              QUẢN LÝ<br/>CONTAINER
            </h1>
            <h1 className="absolute text-7xl font-bold tracking-wider text-blue-400/20 blur-md transform translate-x-4 translate-y-4">
              QUẢN LÝ<br/>CONTAINER
            </h1>
            {/* Main text with gradient */}
            <h1 className="relative text-7xl font-bold tracking-wider bg-gradient-to-br from-white via-blue-100 to-[#00D9A3] bg-clip-text text-transparent drop-shadow-2xl">
              QUẢN LÝ<br/>CONTAINER
            </h1>
          </div>
