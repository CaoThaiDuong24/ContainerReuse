  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestFormats = [
        ...
        // Format 2: userName/passWord (PascalCase)
        {
          userName: formData.username,
          passWord: formData.password
        },
        // Format 3: UserName/Password (PascalCase)
        {
          UserName: formData.username,
          Password: formData.password
        },
        // Format 4: email/password
        {
          email: formData.username,
          password: formData.password
        },
        // Format 5: login/password
        {
      ...
      // Thử format đầu tiên (userName/passWord - PascalCase)
      const requestBody = {
        userName: formData.username,
        passWord: formData.password
      }
      ...
      if (response.ok && data.success && data.data) {
        ...
        const errorMsg = data.message || `Đăng nhập thất bại (${response.status}). ${responseText}`
