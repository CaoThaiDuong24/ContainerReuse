...
export const mockDepots: Depot[] = [
  {
    id: "D001",
    name: "Depot Long Giang",
    location: "Tân Phú, HCM",
    address: "123 Đường Lê Văn Quới, Phường Bình Hưng Hòa A, Quận Bình Tân, TP.HCM",
    image: "/depot-placeholder.jpg",
    containerCount: 5,
    capacity: 100,
    status: 'active',
  ...
  },
  {
    ...
    address: "Khu công nghiệp Phước Đông, Xã Phước Đông, Huyện Nhơn Trạch, Đồng Nai",
    image: "/depot-placeholder.jpg",
    containerCount: 5,
    capacity: 80,
    status: 'active',
  ...
  },
  {
    ...
    address: "Khu công nghiệp Phú Mỹ 1, Thị xã Phú Mỹ, Bà Rịa - Vũng Tàu",
    image: "/depot-placeholder.jpg",
    containerCount: 5,
    capacity: 120,
    status: 'active',
  ...
  },
  {
    id: "D009",
    name: "Depot Cái Mép",
    location: "Cái Mép, Bà Rịa - Vũng Tàu",
    address: "Khu vực cảng Cái Mép, Phường Phước Hòa, Thị xã Phú Mỹ, Bà Rịa - Vũng Tàu",
    image: "/depot-placeholder.jpg",
    containerCount: 5,
    capacity: 150,
    status: 'active',
  ...
  },
  {
    ...
    location: "Nhà Bè, HCM",
    address: "Khu công nghiệp Hiệp Phước, Xã Hiệp Phước, Huyện Nhà Bè, TP.HCM",
    image: "/depot-placeholder.jpg",
    containerCount: 5,
    capacity: 90,
    status: 'active',
  ...
  },
  {
    ...
    address: "Khu công nghiệp Đông An, Phường Bình An, Thành phố Dĩ An, Bình Dương",
    image: "/depot-placeholder.jpg",
    containerCount: 5,
    capacity: 75,
    status: 'active',
  ...
  },
  {
    ...
    address: "Khu công nghiệp Long Bình, Phường Long Bình, TP. Biên Hòa, Đồng Nai",
    image: "/depot-placeholder.jpg",
    containerCount: 3,
    capacity: 85,
    status: 'active',
  ...
  },
  {
    ...
    address: "Khu công nghiệp Long Hậu, Huyện Cần Giuộc, Long An",
    image: "/depot-placeholder.jpg",
    containerCount: 2,
    capacity: 70,
    status: 'active',
  ...
  {
    id: "D022",
    name: "Linh Xuân Logistics Center (LLC)",
    location: "Thủ Đức, HCM",
    address: "Đường Quốc lộ 1A, Phường Linh Xuân, TP. Thủ Đức, TP.HCM",
    image: "/depot-placeholder.jpg",
    containerCount: 3,
    capacity: 95,
    status: 'active',
  ...
  {
    id: "D023",
    name: "Suối Tiên Long Thạnh Mỹ",
    location: "Thủ Đức, HCM",
    address: "Khu vực Suối Tiên, Phường Long Thạnh Mỹ, TP. Thủ Đức, TP.HCM",
    image: "/depot-placeholder.jpg",
    containerCount: 3,
    capacity: 65,
    status: 'active',
  ...
  {
    id: "D024",
    name: "Chân Thật Phú Thuận Depot",
    location: "Quận 7, HCM",
    address: "Khu vực Phú Thuận, Phường Phú Thuận, Quận 7, TP.HCM",
    image: "/depot-placeholder.jpg",
    containerCount: 4,
    capacity: 80,
    status: 'active',
