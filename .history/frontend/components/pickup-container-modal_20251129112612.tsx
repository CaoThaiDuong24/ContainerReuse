  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Đăng ký lấy Container</DialogTitle>
          <DialogDescription>
            Điền đầy đủ thông tin để đăng ký lấy container {containerId}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-4">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="gateType">Loại đơn hàng</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="depotAddress">Địa chỉ Depot</Label>
              <Input 
                id="depotAddress"
            ...
            <div className="space-y-2">
              <Label htmlFor="shippingCompanyMst">
            ...
            <div className="space-y-2">
              <Label htmlFor="inspectionFee">Phí kiểm soát ra vào cổng</Label>
              <Input 
                id="inspectionFee"
                type="number"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="liftFee">Phí nâng hạ</Label>
              <Input 
                id="liftFee"
                type="number"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="containerSize">Loại cont</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="containerFee">Phụ phí xe nâng</Label>
              <Input 
                id="containerFee"
                type="number"
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-red-500">Hình ảnh không được để trống</p>
        </div>
