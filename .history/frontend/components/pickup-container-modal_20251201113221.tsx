  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        if (result.errorCode === '404' || (result.message && result.message.includes('Invalid token'))) {
          errorMessage = '⚠️ Lỗi xác thực với API bên ngoài. Endpoint Create_GateOut_Reuse có thể yêu cầu quyền đặc biệt.'
          console.error('Authentication issue:', result)
        ...
        console.error('Gate-out error details:', {
