  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        // Extract DonHangID from API response
        let orderId = 'N/A';
        ...
        console.log('🎉 Gate Out Success!');
        console.log('📋 Order ID (DonHangID):', orderId);
        console.log('📦 Container:', container?.containerId);
        console.log('🚛 Vehicle:', formData.vehicleNumber);
        console.log('📄 Booking:', formData.bookingNumber);
