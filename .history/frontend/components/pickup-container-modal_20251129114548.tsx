  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="!max-w-[95vw] !w-[95vw] max-h-[95vh] overflow-hidden flex flex-col p-0 gap-0">
            ...
            <div className="space-y-4">
              ...
              {imagePreview ? (
                <div className="relative">
                  <div className="relative h-64 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800">
                    <img 
                      src={imagePreview} 
                      alt="Preview" 
                    ...
                    <Button
                      ...
                      variant="destructive"
                      size="icon"
                      className="absolute top-2 right-2 h-8 w-8 rounded-lg shadow-lg hover:scale-105 transition-transform"
                ...
                <label
                  ...
                  className="relative block w-full h-64 border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-lg cursor-pointer bg-slate-50/50 dark:bg-slate-900/50 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all hover:border-blue-500 dark:hover:border-blue-500 group overflow-hidden"
                >
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">PNG, JPG, GIF (MAX. 5MB)</p>
                  </div>
                  <input
                    id="image-upload"
                    type="file"
        ...
        {/* Footer */}
        <div className="px-8 py-4 border-t bg-slate-50 dark:bg-slate-900/50 flex items-center justify-between shrink-0">
