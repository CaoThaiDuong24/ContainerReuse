              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div className="space-y-2.5">
                  ...
                  <Input 
                    ...
                    placeholder="0 VNĐ"
                    className="h-14 text-base font-semibold bg-green-50 dark:bg-green-900/20 border-2 border-green-500 focus:border-green-600"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="px-6 sm:px-8 py-5 border-t bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shrink-0 shadow-lg">
          ...
          <DialogFooter className="gap-3 sm:gap-3 flex-row w-full sm:w-auto">
            <Button 
              ...
              className="h-14 px-8 text-base flex-1 sm:flex-none border-2"
            >
              Hủy bỏ
            </Button>
            <Button 
              onClick={handleSubmit}
              className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 h-14 px-10 text-base font-semibold shadow-lg shadow-blue-600/40 flex-1 sm:flex-none"
            >
