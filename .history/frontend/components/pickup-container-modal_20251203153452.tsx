          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Mã đơn vị vận tải - Auto-filled from HRMS_UserProfile */}
                <div className="flex flex-col">
                  <Label htmlFor="transportCompanyId" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-red-500 ml-0.5">*</span>
                    {userCompany && (
                      <span className="text-xs text-green-600 dark:text-green-400 ml-1">(Tự động từ HRMS)</span>
                    )}
                  </Label>
                  <Input 
                    ...
                    className={`h-11 text-sm focus-visible:ring-2 focus-visible:ring-blue-500 ${userCompany ? 'bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800' : ''}`}
                    title={userCompany ? `Tự động điền từ HRMS: ${userCompany.name}` : "Nhập mã đơn vị vận tải"}
                  />
                  {loadingUserCompany && (
                    <p className="text-xs text-blue-500 mt-1 flex items-center gap-1">
                      ...
                      Đang lấy ID từ HRMS_UserProfile...
                    </p>
                  )}
                  {!loadingUserCompany && userCompany && (
                    <p className="text-xs text-green-600 dark:text-green-400 mt-1">
                      ✓ Đã tự động điền từ {userCompany.name} (ID: {userCompany.id})
                    </p>
                  )}
                </div>
