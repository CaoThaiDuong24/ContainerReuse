          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col">
                  <div className="min-h-[40px] flex items-center mb-2">
                    <Label htmlFor="dateOfBirth" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        className={cn(
                          "w-full h-11 justify-start text-left font-normal text-sm",
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col">
                  <div className="min-h-[40px] flex items-center mb-2">
                    <Label htmlFor="shippingCompanyMst" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                      <FileText className="h-4 w-4 text-red-500 shrink-0" />
                      <span>MST</span>
                      <span className="text-red-500 ml-0.5">*</span>
                    </Label>
                ...
                <div className="flex flex-col">
                  <div className="min-h-[40px] flex items-center mb-2">
                    <Label htmlFor="companyName" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="flex flex-col">
                  <div className="min-h-[40px] flex items-center mb-2">
                    <Label htmlFor="inspectionFee" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                ...
                <div className="flex flex-col">
                  <div className="min-h-[40px] flex items-center mb-2">
                    <Label htmlFor="liftFee" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                      <DollarSign className="h-4 w-4 text-slate-500 shrink-0" />
                ...
                <div className="flex flex-col">
                  <div className="min-h-[40px] flex items-center mb-2">
                    <Label htmlFor="containerFee" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                      <DollarSign className="h-4 w-4 text-slate-500 shrink-0" />
                      <span>Phụ phí</span>
                    </Label>
                  </div>
                ...
                <div className="flex flex-col">
                  <div className="min-h-[40px] flex items-center mb-2">
                    <Label htmlFor="totalAmount" className="text-sm font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
