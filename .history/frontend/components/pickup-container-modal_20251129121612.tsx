          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5">
                ...
                <div className="flex flex-col">
                  <Label htmlFor="billNumber" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <FileText className="h-4 w-4 text-red-500 shrink-0" />
                    <span className="truncate">Số B/L</span>
                ...
                {/* Depot */}
                <div className="flex flex-col">
                  <Label htmlFor="depot" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                ...
                {/* Hãng tàu */}
                <div className="flex flex-col">
                  <Label htmlFor="shipping" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <PackageCheck className="h-4 w-4 text-red-500 shrink-0" />
                    <span className="truncate">Hãng tàu</span>
                    <span className="text-red-500 shrink-0">*</span>
                  </Label>
                ...
                {/* Loại container */}
                <div className="flex flex-col">
                  <Label htmlFor="containerSize" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <PackageCheck className="h-4 w-4 text-slate-500 shrink-0" />
                    <span className="truncate">Loại Container</span>
                  </Label>
                ...
                {/* Loại đơn hàng */}
                <div className="flex flex-col">
                  <Label htmlFor="gateType" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <PackageCheck className="h-4 w-4 text-slate-500 shrink-0" />
                    <span className="truncate">Loại đơn hàng</span>
                  </Label>
                ...
                {/* Địa chỉ Depot */}
                <div className="flex flex-col">
                  <Label htmlFor="depotAddress" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <PackageCheck className="h-4 w-4 text-slate-500 shrink-0" />
                    <span className="truncate">Địa chỉ Depot</span>
                  </Label>
                  <Input 
                    id="depotAddress"
                ...
                {/* Trạng thái */}
                <div className="flex flex-col">
                  <Label htmlFor="orderStatus" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <PackageCheck className="h-4 w-4 text-slate-500 shrink-0" />
                ...
                {/* Người tạo */}
                <div className="flex flex-col">
                  <Label htmlFor="creator" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-5">
                {/* Đơn vị vận tải */}
                <div className="flex flex-col">
                  <Label htmlFor="transportType" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <Truck className="h-4 w-4 text-red-500 shrink-0" />
                    <span className="truncate">Đơn vị vận tải</span>
                    <span className="text-red-500 shrink-0">*</span>
                  </Label>
                ...
                {/* Số xe */}
                <div className="flex flex-col">
                  <Label htmlFor="vehicleNumber" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <Truck className="h-4 w-4 text-red-500 shrink-0" />
                    <span className="truncate">Số xe</span>
                    <span className="text-red-500 shrink-0">*</span>
                  </Label>
                  <Input 
                    id="vehicleNumber"
                ...
                {/* CMND / Căn cước */}
                <div className="flex flex-col">
                  <Label htmlFor="cmndNumber" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-1.5 mb-2 h-5">
                    <FileText className="h-4 w-4 text-red-500 shrink-0" />
                    <span className="truncate">CMND</span>
                    <span className="text-red-500 shrink-0">*</span>
                  </Label>
