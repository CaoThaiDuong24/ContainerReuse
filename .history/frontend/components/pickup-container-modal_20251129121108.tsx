          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="billNumber" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <FileText className="h-4 w-4 text-red-500 shrink-0" />
                    <span>Số B/L / Số vận đơn</span>
                ...
                {/* Depot */}
                <div className="space-y-2">
                  <Label htmlFor="depot" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                ...
                {/* Hãng tàu */}
                <div className="space-y-2">
                  <Label htmlFor="shipping" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <PackageCheck className="h-4 w-4 text-red-500 shrink-0" />
                    <span>Hãng tàu</span>
                    <span className="text-red-500">*</span>
                  </Label>
                ...
                {/* Loại container */}
                <div className="space-y-2">
                  <Label htmlFor="containerSize" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                ...
                {/* Loại đơn hàng */}
                <div className="space-y-2">
                  <Label htmlFor="gateType" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <PackageCheck className="h-4 w-4 text-slate-500 shrink-0" />
                ...
                {/* Địa chỉ Depot */}
                <div className="space-y-2">
                  <Label htmlFor="depotAddress" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <PackageCheck className="h-4 w-4 text-slate-500 shrink-0" />
                ...
                {/* Trạng thái */}
                <div className="space-y-2">
                  <Label htmlFor="orderStatus" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <PackageCheck className="h-4 w-4 text-slate-500 shrink-0" />
                ...
                {/* Người tạo */}
                <div className="space-y-2">
                  <Label htmlFor="creator" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6">
                {/* Đơn vị vận tải */}
                <div className="space-y-2">
                  <Label htmlFor="transportType" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                ...
                {/* Số xe */}
                <div className="space-y-2">
                  <Label htmlFor="vehicleNumber" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <Truck className="h-4 w-4 text-red-500 shrink-0" />
                    <span>Số xe</span>
                    <span className="text-red-500">*</span>
                  </Label>
                ...
                {/* CMND / Căn cước */}
                <div className="space-y-2">
                  <Label htmlFor="cmndNumber" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <FileText className="h-4 w-4 text-red-500 shrink-0" />
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6">
                {/* MST */}
                <div className="space-y-2">
                  <Label htmlFor="shippingCompanyMst" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <FileText className="h-4 w-4 text-red-500 shrink-0" />
                ...
                {/* Tên công ty */}
                <div className="space-y-2">
                  <Label htmlFor="companyName" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                ...
                {/* Địa chỉ công ty */}
                <div className="space-y-2">
                  <Label htmlFor="address" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <FileText className="h-4 w-4 text-slate-500 shrink-0" />
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-6">
                {/* Phí kiểm soát */}
                <div className="space-y-2">
                  <Label htmlFor="inspectionFee" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <DollarSign className="h-4 w-4 text-slate-500 shrink-0" />
                    <span>Phí kiểm soát cổng</span>
                  </Label>
                  <Input 
                    id="inspectionFee"
                    type="number"
                ...
                {/* Phí nâng hạ */}
                <div className="space-y-2">
                  <Label htmlFor="liftFee" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <DollarSign className="h-4 w-4 text-slate-500 shrink-0" />
                    <span>Phí nâng hạ</span>
                  </Label>
                  <Input 
                    id="liftFee"
                    type="number"
                ...
                {/* Phụ phí xe nâng */}
                <div className="space-y-2">
                  <Label htmlFor="containerFee" className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2 h-5">
                    <DollarSign className="h-4 w-4 text-slate-500 shrink-0" />
                    <span>Phụ phí xe nâng</span>
                  </Label>
                  <Input 
                    id="containerFee"
                    type="number"
                ...
                {/* Tổng tiền */}
                <div className="space-y-2">
                  <Label htmlFor="totalAmount" className="text-sm font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2 h-5">
