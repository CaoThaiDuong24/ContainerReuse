...
async function testHRMSUserProfile() {
  ...
  const testAccountID = '1f1QGXLSeUNqNzAqnF4ZBYHAWu8Wa2QK5DeGbahFCFQTe3PSBcuDwTAW7xWz2yA7ZpmpM8SLMoCiMGQCH2FEExYBTdJdAkE2kkWkxtS5efgQfRoQKwOuQg3B9';
  ...
  try {
    ...
    const testAccountID = '1f1QGXLSeUNqNzAqnF4ZBYHAWu8Wa2QK5DeGbahFCFQTe3PSBcuDwTAW7xWz2yA7ZpmpM8SLMoCiMGQCH2FEExYBTdJdAkE2kkWkxtS5efgQfRoQKwOuQg3B9';
    console.log(`   Testing with AccountID: ${testAccountID.substring(0, 30)}...`);
    ...
    console.log('\n' + '='.repeat(80));
    console.log('📊 RESPONSE FROM HRMS_UserProfile API:');
    console.log('='.repeat(80));
