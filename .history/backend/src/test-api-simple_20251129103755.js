...
async function testApi() {
  ...
  try {
    ...
    const tokenResponse = await axios.get(`${API_URL}/api/data/util/gettokenNonAid`, {
      headers: {
    ...
    const depotResponse = await axios.get(`${API_URL}/api/data/process/iContainerHub_Depot`, {
      headers: {
        'Content-Type': 'application/json'
      },
      data: {
