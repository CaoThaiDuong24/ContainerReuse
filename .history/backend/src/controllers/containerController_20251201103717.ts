...
export const getContainers = async (_req: Request, res: Response): Promise<void> => {
  try {
...
export const getListReUseNow = async (_req: Request, res: Response): Promise<void> => {
  try {
    const { ContainerApiService } = require('../services/containerApiService.js');
    const containerApiService = new ContainerApiService();
    const containers = await containerApiService.getListReUseNow();
...
export const createGateOut = async (req: Request, res: Response): Promise<void> => {
  try {
