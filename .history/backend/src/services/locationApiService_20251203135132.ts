...
class LocationApiService {
  ...
  constructor() {
    ...
    // Initialize with hardcoded location data since GetList_tbLocation API doesn't exist
    this.initializeLocationData();
  }

  /**
   * Initialize location data with hardcoded mapping
   * This data is based on actual city codes from the depot API
   */
  private initializeLocationData(): void {
    const locations: LocationData[] = [
      ...
      { code: '0', name: 'Khác' },
      { code: '1', name: 'Hà Nội' },
      { code: '3', name: 'Bình Dương' },
      { code: '23', name: 'Hải Phòng' },
      { code: '24', name: 'Bình Dương' },
      { code: '36', name: 'Bà Rịa - Vũng Tàu' },
      { code: '39', name: 'Đồng Nai' },
      { code: '41', name: 'Hải Phòng' },
      { code: '51', name: 'TP. Hồ Chí Minh' },
      { code: '56', name: 'Khánh Hòa' },
      { code: '59', name: 'Đà Nẵng' },
      { code: '65', name: 'Campuchia' },
      { code: '74', name: 'Tây Ninh' },
    ...
    console.log('✅ Initialized location data with', locations.length, 'locations');
  }
